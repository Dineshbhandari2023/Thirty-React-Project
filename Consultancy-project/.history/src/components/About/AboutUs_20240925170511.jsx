        ...
        <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
          ...
          <div className="md:7/12 lg:w-6/12">
            ...
            <p className="mt-6 text-gray-600">
              Himalayan White House Education Consultancy is an institute for
              didactic opportunities and career advance where people are
              connected internationally with learning opportunities and
              imaginative thoughts from different countries across the globe. We
              offer free IELTS & visa preparation classes for those students
