...
const NavBar = () => {
  ...
  let Linkness = (type = null) => {
    let classes = "";
    if (type === "sticky")
      return "border-b border-blue-700 dark:border-blue-600";
    if (type === "active")
      return "border-b-2 border-blue-700 dark:border-blue-600";
    return "";
  };
        ...
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
          <ul className="flex p-4 md:p-0 mt-4 font-medium text-lg bg-gray-100 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
            ...
            <li className="m-3">
              <Link
                to={"/about"}
                className="block py-2 px-3 text-gray-900 md:hover:bg-transparent md:hover:text-blue-700 md:p-0"
              >
                About
              </Link>
            </li>
