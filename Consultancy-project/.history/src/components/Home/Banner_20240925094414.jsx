  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center text-center w-full h-full py-20 mt-28">
          <p className="text-1xl text-[#FC5E08] font-semibold font-sans tracking-wide">
