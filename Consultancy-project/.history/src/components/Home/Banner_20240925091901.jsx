    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center text-center w-full h-full py-20">
          <h2 className="text-6xl font-serif m-3 tracking-wider text-gray-700 font-bold">
            Global Aspire Education Consultancy
          </h2>
          <p className="text-xl text-gray-700 font-semibold font-sans tracking-wide my-4 mx-6">
