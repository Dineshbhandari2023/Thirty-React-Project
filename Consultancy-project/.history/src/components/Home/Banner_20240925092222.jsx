    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center text-center w-full h-full py-20">
          <h2 className="text-5xl font-serif m-3 tracking-wider text-[#015598] font-bold">
            Your Gateway to World-Class
          </h2>
          <p className="text-7xl text-[#FC5E08] font-semibold font-sans tracking-wide my-4 mx-6">
            Education in Dubai
          </p>
          <p className="text-xl text-[#FC5E08] font-semibold font-sans tracking-wide my-4 mx-6">
