...
const VisaSuccess = () => {
  return (
    <section className="flex bg-white">
      <img alt="Client Image" className="size-80" src={client3} />
      <img alt="Client Image" className="size-80" src={client4} />
      <img alt="Client Image" className="size-80" src={client5} />
      <img alt="Client Image" className="size-80" src={client6} />
    </section>
  );
};
