  ...
  return (
    <section className="bg-blue-50">
      ...
      <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
        ...
        {/* Features Content */}
        <div className="grid gap-5 sm:grid-cols-2 md:grid-cols-3 md:gap-4 lg:gap-6 shadow-lg">
          {teams.map((team, index) => (
            <div
              key={index}
              className="grid gap-2 rounded-md border border-solid border-gray-300 md:p-10"
            >
              <img
                src={team.img}
                alt="Team-Image"
              ...
              />
              <h3 className="text-3xl font-semibold font-serif">{team.Name}</h3>
