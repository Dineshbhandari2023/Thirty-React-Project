...
const VisaSuccess = () => {
  return (
    <section className="bg-white">
      <img alt="Client Image" className="size-56" src={client3} />
      <img alt="Client Image" className="size-56" src={client4} />
      <img alt="Client Image" className="size-56" src={client5} />
      <img alt="Client Image" className="size-56" src={client6} />
    </section>
  );
};
